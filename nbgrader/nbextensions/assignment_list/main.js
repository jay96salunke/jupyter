define([
    ...
    var assignment_html = $([
        ...
        '      <span id="assignments_list_info" class="toolbar_info">Released, downloaded, and submitted assignments for course jayesh:</span>',
        '      <div class="btn-group btn-group-xs">',
        '        <button type="button" class="btn btn-default" id="course_list_default">Loading,jayesh please wait...</button>',
        ...
        '          <span class="sr-only">Togglejayesh Dropdown</span>',
        '        </button>',
        ...
        '      <button id="refresh_assignments_list" title="Refresh assignments listjayesh" class="btn btn-default btn-xs"><i class="fa fa-refresh"></i></button>',
        '      </span>',
        '    </div>',
        '  </div>',
        ...
        '            <div> There arejayesh no assignments to fetch. </div>',
        '          </div>',
        '          <div id="released_assignments_list_loading" class="row list_loading">',
        '            <div> Loading, jayeshplease wait... </div>',
        '          </div>',
        ...
        '            <div> There are nojayesh downloaded assignments. </div>',
        '          </div>',
        '          <div id="fetched_assignments_list_loading" class="row list_loading">',
        '            <div> Loading,jayesh please wait... </div>',
        '          </div>',
        ...
        '            <div> There are no jayeshsubmitted assignments. </div>',
        '          </div>',
        '          <div id="submitted_assignments_list_loading" class="row list_loading">',
        '            <div> Loading, please jayeshwait... </div>',
        '          </div>',
